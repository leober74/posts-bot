...
- ТОЛЬКО обращение на "ты" — никакого "вы", "ваш", "вам". Пост пишется от живого человека к живому человеку.

ОБЯЗАТЕЛЬНО: в самом конце поста добавь одну финальную строку — нативное приглашение читателей попробовать бота. Она должна выглядеть как личное замечание автора, не как реклама. Например: "P.S. Кстати, этот пост я написал с помощью бота за 3 минуты → https://t.me/${userData.botUsername || 'universal_posts_bot'}" или "Хочешь так же легко писать посты? → https://t.me/${userData.botUsername || 'universal_posts_bot'}" — придумай свой вариант органично вписанный в контекст поста.
