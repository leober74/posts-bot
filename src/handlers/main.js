...
async function handleStart(ctx) {
  ...
  await ctx.reply(
    `Честный вопрос: когда ты последний раз публиковал пост — и он реально сработал?\n\nБольшинство людей или тратят часы и получают тишину, или вообще не публикуют — потому что "не знаю с чего начать" или "а вдруг напишу не так".\n\nА ведь регулярные посты о себе и своём деле работают лучше любой рекламы. И не стоят ни копейки.\n\nЯ делаю это до смешного просто: открываешь, отвечаешь на пару вопросов — и через 3 минуты готов пост, написанный твоим языком, для твоей аудитории. Такой, который захочется опубликовать.\n\nБез курсов. Без шаблонов. Без головной боли.\n\nВыбирай свою кнопку ниже — через 3 минуты ты удивишься насколько это просто 👇`,
    kb.typeKeyboard
  );
