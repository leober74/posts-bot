...
async function handleStart(ctx) {
  ...
  await ctx.reply(
    `Знаешь в чём секрет людей, которые продвигаются без бюджета на рекламу?\n\nОни просто регулярно пишут о себе и своём деле. Всё.\n\nНо большинство так и не начинает — потому что _"не знаю с чего начать"_ или _"напишу не так и потрачу время впустую..."_\n\nЯ сделаю это за тебя — быстро и на таком уровне, что тебе не будет стыдно. Ты отвечаешь на пару вопросов, я собираю глубокий контент для любой твоей соцсети: посты твоим языком, для твоей аудитории, под твои задачи.\n\nТакие, которые тебе очень захочется опубликовать.\n\nБез курсов. Без шаблонов. Без головной боли.\n\nТвой первый пост — уже через 3 минуты 👇`,
    kb.typeKeyboard
  );
